...
public class FindAllQueryParams {
  ...
  public FindAllQueryParams correlationId(@javax.annotation.Nullable String correlationId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("correlationId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FindAllQueryParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FindAllQueryParams is not found in the empty JSON string", FindAllQueryParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FindAllQueryParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FindAllQueryParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
