...
public class TemplateUpsert {
  ...
  public TemplateUpsert id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TemplateUpsert description(@javax.annotation.Nullable String description) {
  ...
  public TemplateUpsert templateContext(@javax.annotation.Nonnull Context templateContext) {
  ...
  public TemplateUpsert templateType(@javax.annotation.Nonnull TemplateType templateType) {
  ...
  public TemplateUpsert title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "description", "templateContext", "templateType", "title"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("templateContext", "templateType", "title"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateUpsert.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in TemplateUpsert is not found in the empty JSON string", TemplateUpsert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateUpsert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TemplateUpsert` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
