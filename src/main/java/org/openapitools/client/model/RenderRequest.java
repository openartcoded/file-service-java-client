...
public class RenderRequest {
  ...
  public RenderRequest context(@javax.annotation.Nullable Object context) {
  ...
  public RenderRequest fileName(@javax.annotation.Nonnull String fileName) {
  ...
  public RenderRequest templateContext(@javax.annotation.Nonnull Context templateContext) {
  ...
  public RenderRequest templateId(@javax.annotation.Nonnull String templateId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("context", "fileName", "templateContext", "templateId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("context", "fileName", "templateContext", "templateId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RenderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RenderRequest is not found in the empty JSON string", RenderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RenderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RenderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("templateId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `templateId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("templateId").toString()));
      }
  }
